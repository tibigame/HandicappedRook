...
namespace Book
{
	...
	void makebook_cmd(Position& pos, istringstream& is)
	{
		...
		// 定跡の上書き
		bool book_overwrite = token == "overwrite";
		// 定跡のsort
		...
		else if (book_merge || book_overwrite) {
